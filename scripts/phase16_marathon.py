...
def run_phase16(episodes=500):
    print("=== Phase 16: The Grandmaster Marathon ===")
    ...
    try:
        value_model.load_state_dict(torch.load("manoid_grandmaster_ckpt_400.pt"), strict=False)
    except:
        pass
    ...
    for ep in range(408, episodes + 1):
